...
exports.default = function (actual) {
  return function (root, result) {
    ...
    root.walkDecls(function (decl) {
      ...
      if (isIgnoredCharacters(value) || !shorthandableProperties.has(_postcss.vendor.unprefixed(prop))) {
        return;
      }
      ...
      if (shortestFormString === valuesFormString) {
        return;
      }
...
var shorthandableProperties = new Set(["margin", "padding", "border-color", "border-radius", "border-style", "border-width"]);
