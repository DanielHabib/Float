  ...
  return function (root, result) {
    ...
    root.walkDecls(function (decl) {
      (0, _postcssValueParser2.default)(decl.value).walk(function (valueNode) {
        if (valueNode.type !== "function" || valueNode.value !== "url" || !valueNode.nodes[0]) {
          return;
        }
        ...
        if (!(0, _utils.isStandardValue)(urlValueNode.value)) {
          return;
        }
        if ((0, _utils.isVariable)(urlValueNode.value)) {
          return;
        }

        var valueContainDataUris = urlValueNode.value.indexOf("data:") === 0;
