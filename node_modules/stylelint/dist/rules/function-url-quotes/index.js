  ...
  return function (root, result) {
    ...
    function check(statement) {
      ...
      statement.walkDecls(function (decl) {
        (0, _utils.functionArgumentsSearch)(decl.toString(), "url", function (args, index) {
    ...
    function checkAtRuleParams(atRule) {
      (0, _utils.functionArgumentsSearch)(atRule.params, "url", function (args, index) {
        if (strDefiesExpectation(args)) {
          (0, _utils.report)({
            message: messages.expected(quoteMsg),
            node: atRule,
            index: index + (0, _utils.atRuleParamIndex)(atRule),
            result: result,
            ruleName: ruleName
          });
        }
      });
      (0, _utils.functionArgumentsSearch)(atRule.params, "url-prefix", function (args, index) {
        if (strDefiesExpectation(args)) {
          (0, _utils.report)({
      ...
      (0, _utils.functionArgumentsSearch)(atRule.params, "domain", function (args, index) {
        if (strDefiesExpectation(args)) {
          (0, _utils.report)({
